...
class InvalidPageInfoException(InvalidHistoryDataElementException):
	def __init__(self, HDE):
		print("The supplied Page Information of the HistoryDataElement object is invalid.")
		print("Size: " + str(HDE.size()))